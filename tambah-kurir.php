...
if(isset($_POST['register'])){
  ...
  $cek_email = mysqli_query($conn, "SELECT * FROM `kurir` WHERE `email` = '$email'");
  ...
  $hasil = mysqli_query($conn, "INSERT INTO `kurir` (`id`, `nama`, `email`, `nomor`, `password`) VALUES (NULL, '$nama', '$email', '$nomor', '$password')");
	if ($hasil > 0){
		echo "<script>alert('Akun berhasil di daftarkan!'); document.location.href='akun-kurir.php';</script>";
		exit;
	}else{
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Tambah Akun Kurir</h1>
              </div>
